...
RewardConfig.Achievements = {
	...
	{ Id = "H1M", Name = "Sky High", Text = "Reach 1M m", Stat = "BestHeight", Goal = 1e6 * M, Gems = 50, Boost = "Height4x" },
	...
	{ Id = "H1B", Name = "Touch The Moon", Text = "Reach 1B m", Stat = "BestHeight", Goal = 1e9 * M, Gems = 120, Boost = "SuperGrowth" },
