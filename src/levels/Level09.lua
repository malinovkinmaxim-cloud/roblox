...
field("r", 5, { 95, 103, 111, 119 }, 2, "e2")
table.insert(elements, K.Floor(131, 0, 0, 14, 10))
table.insert(route, K.Node("e2", 129, 0, 0, { Safe = true }))
table.insert(elements, K.Checkpoint(2, 143, 0, 0))
table.insert(route, K.Node("cp2", 143, 0, 0, { Checkpoint = 2 }))

-- last stretch: vanishing + falling platforms
table.insert(elements, K.Vanish(153, 1, 0, 6, 6, { Visible = 2.4, Hidden = 1.2, Phase = 0 }, { Id = "V1" }))
table.insert(elements, K.Vanish(161, 2, 0, 6, 6, { Visible = 2.4, Hidden = 1.2, Phase = 1.1 }, { Id = "V2" }))
table.insert(elements, K.Falling(169, 3, 0, 5, 5))
table.insert(elements, K.Falling(177, 4, 0, 5, 5))
table.insert(elements, K.Finish(188, 4, 0))
table.insert(route, K.Node("v1", 153, 1, 0, { On = "V1" }))
table.insert(route, K.Node("v2", 161, 2, 0, { On = "V2" }))
table.insert(route, K.Node("f1", 169, 3, 0))
table.insert(route, K.Node("f2", 177, 4, 0))
table.insert(route, K.Node("fin", 188, 4, 0, { Finish = true }))
